...
const EditDetails = ({ details, setShowEditDetails, handleBioChange, updateDetails, infos }) => {
  const modal = useRef(null);

  useOnCLickOutside(modal, () => setShowEditDetails(false));
  return (
    <div className="blur">
      <div className="postBox infosBox" ref={modal}>
        <div className="box_header">
          <div className="small_circle" onClick={() => setShowEditDetails(false)}>
